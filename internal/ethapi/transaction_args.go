...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/bestyourwallet/zkink-go-ethereum/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend) error {
	...
	// other tx values. See https://github.com/bestyourwallet/zkink-go-ethereum/pull/23274
